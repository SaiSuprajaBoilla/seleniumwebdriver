...
public class SliderDemo {
	...
	public static void main(String[] args) {
	    ...
	    System.out.println("default Location of the slider:"+min_slider.getLocation()); //(58, 249)=(x,y)
	    
	    act.dragAndDropBy(min_slider, 100, 249).perform();
	    
	    System.out.println("Location of the min slider after moving:"+min_slider.getLocation());  //(157, 249)=(x,y)
