...
public class FileUpload {
	...
	public static void main(String[] args) {
		...
		/*
		driver.findElement(By.xpath("//input[@id='filesToUpload']")).sendKeys("C:\\Automation\\automationFilesFiles\\Test1.txt");
...
else
{
	System.out.println("Upload failed.");
		...
		*/
		...
		driver.findElement(By.xpath("//input[@id='findToUpload']")).sendKeys(file1+"\n"+file2);
		
		int noOFileUploaded=driver.findElements(By.xpath("//ul[@id='fileList']//li")).size();
		
		//validation 1 - Number of Files
		if(noOFileUploaded==2)
		{
			System.out.println("Files are uploaded");
		}
		else
		{
			System.out.println("Files are not uploaded or incorrect filed uploaded");
		}
