...
public class DatePickerDemo2 {
	...
	//user defined method for converting month from string-->March
...
//convert requiredMonth & dispalyedMonth in to Month objects

Month expectedMonth=covertMonth(requiredMonth);
...
{
	driver.findElement(By.xpath("//span[@class='ui-icon ui-icon-circle-trianle-e']")).click();
}
else
{
	break;
...
//date
List<WebElement> allDates=driver.findElements(By.xpath("//table[@class='ui-datepicker-claender']//tbody//tr//td//a"));
