...
public class FDCalculator {
	...
	public static void main(String[] args) throws IOException {
		...
		for(int i=1;i<=rows;i++)
		{
			...
			Select findElement(By.xpath("div[@class='cal-div']//a[1]")).click();  //clicked on calculate
			...
			if(Double.parseDouble(exp_mvalue)==Double.parseDouble(act_mvalue))
			{
				...
				ExcelUtils.fileGreenColor(filePath, "Sheet1",i,7);
			}
			...
			else
			{
				...
				ExcelUtils.fileRedColor(filePath, "Sheet1",i,7);
			}
			Thread.sleep(3000);
